    ...
    <View style={{ flex: 1 }}>
      <Animated.View
        style={{
          ...
          right: 0,
          top: 0,
          height: props.HEADER_HEIGHT, //HEADER_HEIGHT, // + Constants.statusBarHeight,
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => props.navigation.navigate("SingleVerse")}
        >
      ...
      <Animated.ScrollView
        ...
        style={{
          flex: 1,
          paddingTop: props.HEADER_HEIGHT,
        }}
      >
        <Text>
          {words.map((word, i) =>
...
// export default class BibleScreen extends PureComponent {
//   constructor(props) {
//     super(props);
//     // super(navigation);
...
//     this.setState({ switchValue: toggleValue });
//     // (toggleValue) => {
...
//             right: 0,
//             top: 0,
//             height: this.props.HEADER_HEIGHT, // + Constants.statusBarHeight,
//             backgroundColor: colors.light,
//             zIndex: 1000,
//             elevation: 1000,
//             transform: [{ translateY: this.props.headerY }],
//             alignItems: "center",
//             justifyContent: "flex-start",
//             flexDirection: "row",
//           }}
...
//             onSelectItem={(item) => this.setState({ category: item })}
//             height={this.props.HEADER_HEIGHT}
//             icon="magnify"
...
//             }}
//             onPress={
//               () => this.props.navigation.navigation("SingleVerse")
